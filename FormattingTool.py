...
def modify_toc(doc):
    ...
    for paragraph in toc_paragraphs:      
        ...
        # Set alignment
        if entry4.get().lower() == "center":
            paragraph.paragraph_format.alignment = WD_ALIGN_PARAGRAPH.CENTER
        elif entry4.get().lower() == "left":
            paragraph.paragraph_format.alignment = WD_ALIGN_PARAGRAPH.LEFT
        elif entry4.get().lower() == "right":
            paragraph.paragraph_format.alignment = WD_ALIGN_PARAGRAPH.RIGHT
        elif entry4.get().lower() == "justify":
    ...
    for para in toc_paragraphs:
        if has_bold(para):  # Check if paragraph contains bold text
            ...
            # Set title alignment
            if entry9.get().lower() == "center":
                para.paragraph_format.alignment = WD_ALIGN_PARAGRAPH.CENTER
            elif entry9.get().lower() == "left":
                para.paragraph_format.alignment = WD_ALIGN_PARAGRAPH.LEFT
            elif entry9.get().lower() == "right":
                para.paragraph_format.alignment = WD_ALIGN_PARAGRAPH.RIGHT
            elif entry9.get().lower() == "justify":
...
def new_window(doc):
    ...
    section_text = tk.CTkLabel(new_win, text="Font", width=120, height=0, font=("Arial", 15), text_color="black")
    section_text.place(x=245, y=15)
